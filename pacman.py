...
class Dot(GameObject):
    ...
    def __init__(self, x, y, tile_size, map_size):
        GameObject.__init__(self, './resources/ballon24.png', x, y, tile_size, map_size)
        self.direction = 0
        self.velocity = 0
        self.eaten = False
...
if __name__ == '__main__':
    ...
    ghost1 = Ghost(1, 0, tile_size, map_size)
    ghost2 = Ghost(3, 0, tile_size, map_size)
    ...
    while 1:
        ...
        for w in walls:
            w.draw(screen)
        if (int(ghost1.x) == int(pacman.x) and int(ghost1.y) == int(pacman.y)) or (int(ghost2.x) == int(pacman.x) and int(ghost2.y) == int(pacman.y)) :
            win = False
            break
        i=0
        for dot in dots:
